...
// List of all color keywords from w3schools. Used to validate user color selections
...
const questions = [
    ...
    // Select color with color keyword
    {
        ...
        // Ensure that the user enters a valid color Keyword
        validate: (input) => {
    ...
    // Select color with hexadecimal
    {
        ...
        // Ensure the user enters a valid hexadecimal
        validate: (input) => {
